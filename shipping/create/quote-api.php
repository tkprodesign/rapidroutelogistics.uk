...
<tr><td style="padding:0 40px 24px 40px;"><a href="https://rapidroutelogistics.uk/control-panel/page/#cp-edit-service-quote" style="display:inline-block;background-color:#1d4ed8;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:6px;font-size:14px;font-weight:bold;">Go to Control Panel</a></td></tr>
