                            <article class="ship-card">
                                ...
                                <div class="summary-card" style="margin-top:16px;">
                                    ...
                                    <div class="sum-row js-payment-total-crypto-row" hidden><span>Blockchain Network Processing Fee</span><strong id="payment-total-crypto-value">$<?= number_format($payment_total_crypto_fee, 2) ?></strong></div>
