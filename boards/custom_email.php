                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 4px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td align="center" style="padding: 0 60px 40px 60px; color: #333333;">
                            <p style="font-size: 16px; margin: 0 0 15px 0;">Hi tkprodesign,</p>
                            <h1 style="font-size: 28px; line-height: 1.3; margin: 0 0 20px 0; font-weight: 500;">Alert.</h1>
                            <p style="font-size: 14px; color: #666666; margin: 0 0 30px 0;">Your package xxx pleass.</p>
                            ...
                            <p style="font-size: 13px; color: #888888; margin: 40px 0 0 0;">Message 2</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="background-color: #f9f9f9; padding: 30px 40px; border-top: 1px solid #eeeeee;">
                            ...
                            <p style="font-size: 11px; margin: 0;">
                                <a href="#" style="color: #666666; text-decoration: underline;">Privacy Notice</a> | 
                                <a href="#" style="color: #666666; text-decoration: underline;">Service Terms</a> | 
                                <a href="#" style="color: #666666; text-decoration: underline;">Help & Support</a>
                            </p>
                        </td>
                    </tr>
