...
<head>
    ...
    <link rel="stylesheet" href="/assets/stylesheets/premium-design.css?v=<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/assets/stylesheets/premium-design.css'); ?>">
...
<section class="hero premium-scene" data-premium-scene="hero">
    ...
    <div class="swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide hero-1 is-active">
    ...
    <div class="container">
        <div class="trust-content">
            <div class="trust-header fade-up">
                ...
                <p>Certified, secure, and compliant with global logistics standards</p>
            </div>
            <div class="trust-grid stagger-children">
                ...
                <div class="trust-badge">
                    ...
                    <h4>AEO Certified</h4>
                    <p>Authorized Economic Operator</p>
                </div>
                <div class="trust-badge">
                    <div class="badge-icon">
            ...
            <div class="partner-logos fade-up">
                <p class="partner-label">Proud partners with</p>
                <div class="logo-marquee">
                    <div class="logo-track">
                        <span class="partner-name">Amazon</span>
                        <span class="partner-name">DHL</span>
                        <span class="partner-name">FedEx</span>
                        <span class="partner-name">UPS</span>
                        <span class="partner-name">Shopify</span>
                        <span class="partner-name">WooCommerce</span>
                        <span class="partner-name">Amazon</span>
                        <span class="partner-name">DHL</span>
                        <span class="partner-name">FedEx</span>
                        <span class="partner-name">UPS</span>
...
<section class="testimonials-section">
    <div class="container">
        <div class="testimonials-header fade-up">
            ...
            <p>Join thousands of satisfied businesses and individuals</p>
        </div>
        <div class="testimonial-carousel">
            <div class="testimonial-track">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"Rapid Route has transformed our supply chain. 99% on-time delivery and their tracking system is flawless."</p>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <svg viewBox="0 0 100 100" class="avatar-svg">
                                <circle cx="50" cy="35" r="25" fill="var(--accent-primary)" opacity="0.3"/>
                                <circle cx="50" cy="100" r="45" fill="var(--accent-primary)" opacity="0.2"/>
                            </svg>
                        </div>
                        <div class="author-info">
                            <h4>Sarah Mitchell</h4>
                            <p>Operations Director, TechFlow Inc.</p>
                            <div class="rating">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"Best courier service we've used. Same-day delivery saved our product launch. Highly recommended!"</p>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <svg viewBox="0 0 100 100" class="avatar-svg">
                                <circle cx="50" cy="35" r="25" fill="var(--accent-secondary)" opacity="0.3"/>
                                <circle cx="50" cy="100" r="45" fill="var(--accent-secondary)" opacity="0.2"/>
                            </svg>
                        </div>
                        <div class="author-info">
                            <h4>James Chen</h4>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">"The customer support is exceptional. They helped resolve a complex international shipping issue within hours."</p>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <svg viewBox="0 0 100 100" class="avatar-svg">
                                <circle cx="50" cy="35" r="25" fill="#6366f1" opacity="0.3"/>
                                <circle cx="50" cy="100" r="45" fill="#6366f1" opacity="0.2"/>
                            </svg>
                        </div>
                        <div class="author-info">
                            <h4>Emma Rodriguez</h4>
                            <p>Import Manager, GlobalTrade Co.</p>
                            <div class="rating">
                                <span class="material-symbols-outlined filled">star</span>
                                <span class="material-symbols-outlined filled">star</span>
                                <span class="material-symbols-outlined filled">star</span>
...
<!-- ── STICKY TRACKING BAR ── -->
<div class="sticky-tracking-bar" id="stickyTrackingBar">
    <div class="container">
        <div class="tracking-bar-content">
            <div class="tracking-label">
                <span class="material-symbols-outlined">local_shipping</span>
                <span>Track your shipment</span>
            </div>
            <form class="tracking-form" action="/track/" method="get">
                <input type="text" name="id" placeholder="Enter tracking number" class="tracking-input">
                <button type="submit" class="tracking-btn">
                    <span class="material-symbols-outlined">search</span>
                    Track
                </button>
            </form>
            <button class="close-bar" id="closeTrackingBar" aria-label="Close tracking bar">
